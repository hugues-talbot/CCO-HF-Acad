...
A random position is picked, that has to fulfill two constraints: belong to the perfusion territory and respect a distance criteria. 
This criteria is defined based on the final and current size of the tree:
\begin{equation}
